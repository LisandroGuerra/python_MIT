...
lo = balance / 12.0
hi = (balance * (1 + mir) ** 12) / 12.0
mmp = 0
while rp > e or rp < - e:
    mmp = (lo + hi) / 2
    rp = balance
    for month in range(1, 13):
            rp = rp - mmp + (rp - mmp) * mir
    if rp > e:
        lo = mmp
    elif rp < - e:
        hi = mmp
print 'Lowest Payment: ', round(mmp, 2)
...
print bal(320000, 0.2)
print bal(999999, 0.18)
'''


'''
 Problem 3: Using Bisection Search to Make the Program Faster (25 pontos possíveis)
